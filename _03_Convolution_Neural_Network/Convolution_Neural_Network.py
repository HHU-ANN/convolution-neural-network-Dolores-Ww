...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(in_channels=1024, out_channels=2048, kernel_size=3, padding=1)
        self.relu3 = nn.ReLU()
        self.pool3 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.fc = nn.Linear(16 * 16 * 128, 10) # Output layer
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 16 * 16* 128) # Flatten the input tensor
        x = self.fc(x)
